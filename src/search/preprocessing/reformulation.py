"""
Query Reformulation for Code RAG (preprocessing, **до** retrieval).
...
Не путать с :class:`src.search.pipeline.services.rewriter_service.RewriterService`,
который работает **после** retrieval внутри RAG-loop'а на основе quality-feedback.
Здесь — preprocessing с дисковым кешем; там — single-shot rewrite по фидбэку.
"""
